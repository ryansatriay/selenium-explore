...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"alert\">{{message}}</div>\n<div id=\"orderPageLink\">\n    <a href=\"#\" (click)=\"orderPage()\">Back to Order Page</a>\n</div>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"footerWrapper\">\n    <span>All rights reserved 2020 @KopeeTearia</span>\n</div>");
...
const routes = [
    { path: '', component: _order_order_component__WEBPACK_IMPORTED_MODULE_3__["OrderComponent"] },
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
// URL for the actual server application.properties file of order-billing-ws web service
// export const API_URL = 'http://localhost:8090/kopeetearia';

// Specify URL for tomcat server
// port: 8085
// url used: kopeeteria-ws
const API_URL = 'http://localhost:8085/kopeetearia-ws';
...
/* harmony import */ var _promo_promo_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./promo/promo.component */ "./src/app/promo/promo.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _promo_promo_component__WEBPACK_IMPORTED_MODULE_11__["PromoComponent"]
        ],
        imports: [
...
let OrderComponent = class OrderComponent {
    ...
    showRegularBill() {
        this.backend.getOrders(`${_app_constants__WEBPACK_IMPORTED_MODULE_3__["API_URL"]}/order/bill/regular`).subscribe((data) => {
            this.clerk = data['clerk'];
            this.orderArr = data['orderList'];
            this.totalRegularBill = data['totalBill'];
        }, () => {
            this.message = 'Cannot load details. Something went wrong.';
            this.messageStyle = 'alert';
        });
    }
    showDiscountedBill() {
        this.backend.getOrders(`${_app_constants__WEBPACK_IMPORTED_MODULE_3__["API_URL"]}/order/bill/discounted`).subscribe((data) => {
    ...
    addOrder() {
        ...
        this.backend.postOrder(orderObj).subscribe(() => {
            this.showRegularBill();
            this.showDiscountedBill();
            this.setEmptyFields();
            this.message = 'Order is successfully added.';
            this.messageStyle = 'success';
        }, () => {
            this.message = 'Unable to add order. Something went wrong.';
            this.messageStyle = 'alert';
        });
    }
    editItem(order) {
    ...
    updateOrder() {
        this.createOrderObj();
        this.backend.updateOrder(this.orderObj).subscribe(() => {
            this.showRegularBill();
            this.showDiscountedBill();
            // this.showUpdateBtn = false;
            this.cancelUpdate();
            this.message = 'Order is successfully updated.';
            this.messageStyle = 'success';
        }, () => {
            this.message = 'Unable to update order. Something went wrong.';
            this.messageStyle = 'alert';
        });
    }
    cancelUpdate() {
    ...
    deleteItem(order) {
        this.backend.deleteOrder(order).subscribe(() => {
            this.showRegularBill();
            this.showDiscountedBill();
            this.message = 'Order is successfully deleted.';
            this.messageStyle = 'success';
        }, () => {
            this.message = 'Unable to delete order. Something went wrong.';
            this.messageStyle = 'alert';
        });
    }
    closeBtn() {
...
PromoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-promo',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./promo.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/promo/promo.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./promo.component.css */ "./src/app/promo/promo.component.css")).default]
    })
], PromoComponent);
...
let BackendService = class BackendService {
    ...
    getOrders(urlEndpoint) {
        return this.http.get(urlEndpoint);
    }
    postOrder(order) {
        return this.http.post(`${_app_constants__WEBPACK_IMPORTED_MODULE_3__["API_URL"]}/orders`, order);
    }
    deleteOrder(order) {
        const payload = {
        ...
        return this.http.delete(`${_app_constants__WEBPACK_IMPORTED_MODULE_3__["API_URL"]}/orders`, payload);
    }
    updateOrder(order) {
        return this.http.put(`${_app_constants__WEBPACK_IMPORTED_MODULE_3__["API_URL"]}/orders`, order);
    }
};
...
module.exports = __webpack_require__(/*! C:\WORKSPACES\checkpoints\order-billing-client\frontend\order-billing-client\src\main.ts */"./src/main.ts");
